...
public class NoticeController {
  ...
  public String update(int noticeno, Model model) {
    model.addAttribute("dto",service.read(noticeno)); //read로 글을 읽어오기
    
    return "/notice/update";
  }
  
  
  @GetMapping("/notice/read") //리턴한 값을 보내줘야하므로 Model객체에 담아서 보내줌(그 보내준걸 request로 받아오는것)
  ...
  @RequestMapping("/notice/list") //@RequestMapping : get도 되고 post도 된다는 뜻
