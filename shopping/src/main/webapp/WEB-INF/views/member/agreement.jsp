...
<form class="form-horizontal" 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
    <textarea rows="20" cols="100" id="content" name="content" class="form-control" style="font-size:15px;">DAILY 서비스약관 (2005. 7. 18 부터 유효) 
 
제1조(목적)
이 약관은 DAILY 회사(전자상거래 사업자)가 운영하는 DAILY 사이트 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란  DAILY 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
#카카오톡 알림톡 시행에 관한 내용
“DAILY”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내 드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다. 

제21조(포인트)

회사는 회원이 쇼핑몰 내에서 상품을 구매하거나, 상품평의 작성, 상품 배송확인 등을 하는 경우 회원에게 일정한 포인트를 부여할 수 있습니다. 다만, 상품구매 후 취소 또는 반품을 할 경우에는 상품 구매 시 회사가 부여한 포인트를 회수합니다.
포인트의 유효기간은 발행일로부터 1년이며, 회사가 별도로 유효기간을 정한 때에는 이에 따릅니다. 회사는 포인트의 유효기간이 도래하기 30일 전 회원에게 통지합니다.  
회원은 회사가 정하는 절차와 조건에 따라 회사가 운영하는 쇼핑몰에서 상품구매시 단독으로 또는 다른 결제수단과 함께 포인트를 사용할 수 있습니다.
포인트는 현금으로 전환하거나 환불될 수 없습니다. 포인트는 회사에서 별도로 명시한 경우를 제외하고는 타인에게 양도할 수 없으며 부정한 목적이나 용도로 사용할 수 없습니다. 이 경우 회사는 해당사유를 통지하고 포인트를 박탈하거나 회원자격을 정지할 수 있습니다.
 

제22조(할인쿠폰)

회사는 회원에게 상품 구매시 일정 금액 또는 일정비율울 할인 받을 수 있는 할인쿠폰을 발급할 수 있습니다. 할인쿠폰은 웹사이트를 통해서 발급되며, 할인쿠폰의 종류 및 내용과 발급여부는 회사의 정책에 따라 변경될 수 있습니다.
할인쿠폰은 사전에 명시된 유효기간 내에 사용될 수 있으며, 유효기간이 경과하거나 회원 자격이 상실되면 소멸합니다.
할인쿠폰은 회원 본인의 구매에만 사용할 수 있으며, 어떠한 경우에도 타인에게 양도 또는 대여하거나 담보의 목적으로 사용할 수 없습니다.
회원이 할인쿠폰을 사용하여 구매한 제품을 취소나 반품하는 경우, 환불금액은 할인쿠폰을 통해 할인된 금액 등을 제외하고 회원이 실제 지급한 금액으로 합니다. 환불이 이루어졌을 때에는 할인쿠폰의 재사용이 불가능할 수 있습니다.
제23조 (포인트 및 쿠폰)
1. 회사는 회원이 쇼핑몰 내에서 상품을 구매하거나, 상품평의 작성, 상품 배송확인 등을 하는 경우 회원에게 일정한 포인트를 부여할 수 있습니다. 다만, 상품구매 후 취소 또는 반품을 할 경우에는 상품 구매 시 회사가 부여한 포인트를 회수합니다.
2. 포인트의 유효기간 및 사용방법은 회사의 정책에 따릅니다.
3. 회사는 회원에게 일정 금액 또는 일정비율을 할인 받을 수 있는 쿠폰을 발급할 수 있습니다. 쿠폰의 종류 및 내용과 발급여부 및 사용방법은 회사의 정책에 따라 변경될 수 있습니다.
4. 쿠폰은 사전에 명시된 유효기간 내에 사용될 수 있으며, 유효기간이 경과하거나 회원 자격이 상실되면 소멸합니다.
5. 회사는 포인트 및 쿠폰과 관련하여 다음의 사항을 회원에게 통지합니다.
  ①회원 가입 혜택의 부여
  ②첫 구매 고객에게 감사 쿠폰의 부여
  ③포인트 또는 쿠폰의 유효기간 만료 및 소멸
  ④등급별 지급되는 월별 쿠폰
  ⑤그 외 포인트 및 쿠폰의 부여, 사용, 만료, 소멸 등에 관한 사항 </textarea>
    </div>
  </div>
